...
WEB_PARAMS = [
    ...
    {"name": "expense_gl_account", "label": "Conta de despesa", "type": "text", "required": True},
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Criar Documento FI de Fornecedor em QAD via BAPI.")
    ...
    parser.add_argument("--expense-gl-account", dest="expense_gl_account", required=True)
