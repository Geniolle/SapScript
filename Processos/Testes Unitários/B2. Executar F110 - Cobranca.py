...
from sap_rfc.f110_service import OPERATION_COBRANCA, run_f110_proposal
...
# Este processo só executa a PROPOSTA do F110 (Vorlauf). Nunca dispara a cobrança real.
WEB_PARAMS = [
    {
        "name": "environment",
        "label": "Ambiente",
    ...
    {"name": "payment_method", "label": "Forma de cobrança", "type": "text", "required": True},
    {"name": "customer_account", "label": "Cliente", "type": "text", "required": True},
    {
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Executar proposta F110 (cobrança a cliente) via RFF110S.")
    ...
    parser.add_argument("--customer-account", dest="customer_account", required=True)
