...
WEB_PARAMS = [
    ...
    {"name": "revenue_gl_account", "label": "Conta de receita", "type": "text", "required": True},
    {"name": "amount", "label": "Valor líquido", "type": "number", "required": True, "step": "0.01"},
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Criar Documento FI de Cliente em QAD via BAPI.")
    ...
    parser.add_argument("--revenue-gl-account", dest="revenue_gl_account", required=True)
